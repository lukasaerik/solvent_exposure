...
def cif_to_df(path:str):
    ...
    start_cols_override = {
        ...
        '_atom_site.label_entity_id': 41,
        '_atom_site.label_seq_id': 46,
        '_atom_site.pdbx_PDB_ins_code': 51,
        '_atom_site.Cartn_x': 53,
        '_atom_site.Cartn_y': 62,
        '_atom_site.Cartn_z': 71,
        '_atom_site.occupancy': 80,
        '_atom_site.B_iso_or_equiv': 85,
        '_atom_site.pdbx_formal_charge': 93,
        '_atom_site.auth_seq_id': 95,
        '_atom_site.auth_comp_id': 101,
        '_atom_site.auth_asym_id': 107,
        '_atom_site.auth_atom_id': 113,
        '_atom_site.pdbx_PDB_model_num': 121
    }
